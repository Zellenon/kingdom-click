...
pub const BALL_STARTING_POSITION: Vec3 = const_vec3!([0.0, -50.0, 1.0]);
pub const BALL_SIZE: Vec3 = const_vec3!([30.0, 30.0, 0.0]);
pub const BALL_SPEED: f32 = 400.0;
pub const INITIAL_BALL_DIRECTION: Vec2 = const_vec2!([0.5, -0.5]);
...
impl Plugin for LevelPlugin {
    fn build(&self, app: &mut App) {
        let physics_system = SystemSet::new()
...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    // Sound
    let ball_collision_sound = asset_server.load("sounds/hit.ogg");
...
impl WallLocation {
    ...
    pub fn size(&self) -> Vec2 {
        ...
        // Make sure we haven't messed up our pub constants
